...
public interface CurriculumSectionContentService {
	 ...
	 */
	List<CurriculumSectionContent> doGetAllCurriculumSectionContents() throws BusinessServiceException;
	 ...
	 * @throws BusinessServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentById(Long id) throws BusinessServiceException;
