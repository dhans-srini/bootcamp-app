...
public class CurriculumSectionContentServiceImpl implements CurriculumSectionContentService {
	...
	@Override
	public List<CurriculumSectionContent> doGetAllCurriculumSectionContents() throws BusinessServiceException {
	...
	@Override
	public List<CurriculumSectionContent> doGetCurriculumSectionContentById(Long id) throws BusinessServiceException {
		List<CurriculumSectionContent> curriculumSectionContents = new ArrayList<>();
		try {
	...
	public void doUpdateCurriculumSectionContentDisplayOrder(CurriculumSectionContent curriculumSectionContent)
			throws BusinessServiceException {
		try {
			curriculumSectionContentDAO.doUpdateCurriculumSectionContentDisplayOrder(curriculumSectionContent);
		} catch (DataServiceException e) {
			throw new BusinessServiceException(e.getMessage(), e);
		}
	}
