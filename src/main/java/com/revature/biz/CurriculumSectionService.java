...
public interface CurriculumSectionService {
	 ...
	 * @throws BusinessServiceException
	 */
	List<CurriculumSection> doGetCurriculumSectionByCurriculumId(Long curriculumId) throws BusinessServiceException;
	 ...
	 * @throws BusinessServiceException
	 */
	void doUpdateCurriculumSection(CurriculumSection curriculumSection) throws BusinessServiceException;
