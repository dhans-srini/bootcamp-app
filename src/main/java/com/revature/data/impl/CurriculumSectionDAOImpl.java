...
public class CurriculumSectionDAOImpl implements CurriculumSectionDAO {
  ...
  public List<CurriculumSectionVO> doGetAllCurriculumSections() throws DataServiceException {
    ...
    try {
      ...
      curriculumSectionVOs =
          dataRetriever.retrieveBySQLResultTransformer(query.toString(), CurriculumSectionVO.class);
  ...
  public List<CurriculumSectionVO> doGetCurriculumSectionById(Long id) throws DataServiceException {
    ...
    try {
      ...
      curriculumSectionVOs = dataRetriever.retrieveBySQLResultTransformer(query.toString(),
          queryParam, CurriculumSectionVO.class);
      LOG.debug("Query execution success");
    } catch (DataAccessException e) {
      LOG.error(e.getMessage(), e);
      throw new DataServiceException(e.getMessage(), e);
  ...
  @Override
  public List<CurriculumSectionVO> doGetCurriculumSectionByCurriculumId(Long curriculumId)
  ...
  @Override
  public void doSaveCurriculumSection(CurriculumSection curriculumSection)
      throws DataServiceException {
    try {
  ...
  @Override
  public void doUpdateCurriculumSection(CurriculumSection curriculumSection)
      throws DataServiceException {
    try {
  ...
  public void doUpdateCurriculumSectionDisplayOrder(CurriculumSection curriculumSection)
    ...
    try {
      String query =
          "UPDATE curriculum_sections cs SET cs.display_order=:displayOrder WHERE cs.id=:id";
      List<QueryParameter<?>> queryParam = new ArrayList<>();
  ...
  @Override
  public void doDeleteCurriculumSection(CurriculumSection curriculumSection)
      throws DataServiceException {
    try {
