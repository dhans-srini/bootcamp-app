...
public class CurriculumSectionContentDAOImpl implements CurriculumSectionContentDAO {
  ...
  @Override
  public List<CurriculumSectionContent> doGetAllCurriculumSectionContent()
  ...
  public List<CurriculumSectionContent> doGetCurriculumSectionContentById(Long id)
    ...
    try {
      ...
      curriculumSectionContents =
          dataRetriever.retrieveByHQL("from CurriculumSectionContent where id=:id", queryParam);
      LOG.debug("Query execution success");
    } catch (DataAccessException e) {
      LOG.error(e.getMessage(), e);
      throw new DataServiceException(e.getMessage(), e);
  ...
  @Override
  public List<CurriculumSectionContent> doGetCurriculumSectionContentByCurriculumSectionId(
  ...
  public List<CurriculumSectionContent> doGetCurriculumSectionContentByModuleId(Long moduleId)
    ...
    try {
      ...
      curriculumSectionContents = dataRetriever.retrieveByHQL(
          "from CurriculumSectionContent csc join fetch csc.module m where m.id=:moduleId",
          queryParam);
      LOG.debug("Query execution success");
    } catch (DataAccessException e) {
      LOG.error(e.getMessage(), e);
  ...
  @Override
  public List<CurriculumSectionContent> doGetCurriculumSectionContentByCurriculumActivityId(
  ...
  public List<CurriculumSectionContent> doGetCurriculumSectionContentByParentActivityId(
    ...
    try {
      ...
      List<QueryParameter<?>> queryParam = new ArrayList<>();
      queryParam
          .add(new QueryParameter<>("parentCurriculumActivityId", parentCurriculumActivityId));
      curriculumSectionContents = dataRetriever.retrieveByHQL(
  ...
  public void doUpdateCurriculumSectionContentDisplayOrder(
    ...
    try {
      String query =
          "UPDATE curriculum_section_contents csc SET csc.display_order=:displayOrder WHERE csc.id=:id";
      List<QueryParameter<?>> queryParam = new ArrayList<>();
      queryParam.add(new QueryParameter<>("id", curriculumSectionContent.getId()));
      queryParam
          .add(new QueryParameter<>("displayOrder", curriculumSectionContent.getDisplayOrder()));
