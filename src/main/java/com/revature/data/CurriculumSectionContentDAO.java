...
public interface CurriculumSectionContentDAO {
	 ...
	 * @throws DataServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentById(Long id) throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	void doSaveCurriculumSectionContent(CurriculumSectionContent curriculumSectionContent) throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	void doUpdateCurriculumSectionContentDisplayOrder(CurriculumSectionContent curriculumSectionContent)
			throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentByParentActivityId(Long parentCurriculumActivityId)
			throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentByCurriculumSectionId(Long curriculumSectionId)
			throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentByModuleId(Long moduleId) throws DataServiceException;
	 ...
	 * @throws DataServiceException
	 */
	List<CurriculumSectionContent> doGetCurriculumSectionContentByCurriculumActivityId(Long curriculumActivityId)
			throws DataServiceException;
