...
public class Employee implements Serializable, Comparable<Employee> {
  ...
  public void setOrgId(BigInteger orgId) {
    this.orgId = TypeConversionUtil.toLong(orgId);
  }
  ...
  public String getImageUrl() {
    if (getId() != null) {
      ...
      String imageUrl = PropertiesFileUtils.getValue("application", "employee_image_download_url");
      if (getUniqueName() != null) {
        imageUrl = imageUrl.replace("{id}", getUniqueName());
        this.imageUrl = baseLocation + imageUrl;
      }
    }
    return imageUrl;
  }
